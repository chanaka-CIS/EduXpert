        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{route('role_create')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('teacher_list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>List Teacher</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('student_create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Student</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('class_create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Classes</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('class_list')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Classes list</p>
                </a>
              </li>
